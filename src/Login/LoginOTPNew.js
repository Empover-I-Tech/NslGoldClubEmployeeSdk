...
function LoginOTPNew({ route }) {
  ...
  const [verifyBtnEnable, setVerifyBtnEnable] = useState(true)
            ...
            <CustomButton
              ...
              onPress={() => {
                ...
                navigation.reset({
                  index: 0,
                  routes: [{
                    name: (roleNameNav === 'Retailer' || roleNameNav === 'Distributor') ? 'RetailerDashboard' : 'EmployeeDashboard',
                    params: {
      ...
      <View style={[styles['full_screen'], { padding: 0, margin: 0, width: '100%', height: '100%' }]}>
        ...
        <View style={[styles['absolute_position'], styles['padding_top_10'], styles['align_self_center']]}>
          ...
          <View style={[styles['margin_top_10']]}>
            ...
            {verifyBtnEnable && <View style={[styles['centerItems'], styles['width_100%']]}>
              <CustomButton
                title={translate('verify')} onPress={verifyOTPButtonPress} buttonBg={Colors.buttonColorPurple} btnWidth={"90%"} titleTextColor={Colors.white} />
            </View>}
          </View>
        </View>
