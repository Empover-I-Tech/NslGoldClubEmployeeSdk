...
import { View, Text, Modal, FlatList, Image, TouchableOpacity, AppState, Keyboard, TextInput } from 'react-native';
...
const CustomListViewModal = ({
    ...
    const onPressDropdownItem = (item) => {
        ...
        const actions = {
            ...
            [strings.sub_district]: onSelectedSubDistrict,
            [strings.villageCity]: onSelectedVillage,
                        ...
                        <TextInput
                            ...
                            style={[
                                ...
                                styles['border_1'],
                                {
                                    ...
                                    color: dynamicStyles?.textColor || 'rgba(0, 0, 0, 1)',
                                }
                            ]}
