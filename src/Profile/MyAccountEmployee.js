...
import { View, Platform, StatusBar, Text, Image, Linking, Keyboard, TouchableOpacity, Modal, FlatList, ScrollView } from 'react-native';
...
import { MOBILE_NUMBER, PROFILEIMAGE, ROLEID, ROLENAME, USER_ID, filterObjects, retrieveData, sortObjectsAlphabetically, storeData } from '../assets/Utils/Utils';
                ...
                <ScrollView automaticallyAdjustKeyboardInsets={Platform.OS == 'ios' ? false : true} style={[{ height: '100%', backgroundColor: Colors.white }]}>
                    ...
                    <View style={[styles['width_100%'], styles['bg_white'], { flex: 1, height: '100%', marginBottom: 75 }]}>
                        <View style={[styles['bg_white'], styles['width_100%'], styles['height_100%']]}>
                            ...
                            <View style={[styles['shadow_box'], styles['bg_white'], styles['align_self_center'], styles['border_radius_5'], styles['margin_top_10'], { width: '90%', paddingBottom: sectionGeneralOpen ? 20 : 5 }]}>
                                        ...
                                        <View style={[styles['margin_top_10']]}>
                                            <CustomTextInput
                                                ...
                                                onChangeText={(text) => {
                                                    ...
                                                    if (alphabetRegex.test(formattedText.trim())) {
                                                        updateEmployeeDetails('city', formattedText);
                                                    }
                                                }}
                                                onEndEditing={event => {
                                            ...
                                            <CustomTextInput
                                                ...
                                                onChangeText={(text) => {
                                                    ...
                                                    if (formattedText === '' || alphabetRegex.test(formattedText.trim())) {
                                                        updateEmployeeDetails('village', formattedText);
                                                    }
                                                }}
                                                onEndEditing={event => {
